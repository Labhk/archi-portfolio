                        ...
                        <div className=" p-6 bg-white flex ">
                            <form>
                                ...
                                <div className="w-[20rem]">
                                    <input type="text" name="" className='w-full py-[5px] text-[16px] px-0 mx-0 my-[10px] mb-1  border-b-2 border-gray-700 outline-none text-gray-700' required />
                                ...
                                <div className="">
                                    <textArea required className='w-full py-[5px] text-[16px] px-0 mx-0 my-[10px] mb-1   border-b-2 border-gray-700 outline-none text-gray-700'></textArea>
