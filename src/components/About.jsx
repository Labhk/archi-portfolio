    ...
    return (
        <>
            <div className="min-h-screen flex justify-center items-center " id="about-section">
                ...
                <div className="container mx-auto px-4 " data-aos="fade-up" data-aos-duration="1300">
                    <div className="flex flex-col md:flex-row ">
                        <div className="md:w-1/2 md:pr-14" data-aos="fade-right" data-aos-duration="1300">
                            <img
